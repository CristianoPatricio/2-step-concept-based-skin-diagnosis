...
from engine import x_to_c, c_to_y
...
def step_1(pil_image):
    ...
    predicted_concepts, raw_scores = x_to_c(pil_image=pil_image)
...
def step_2(intermediate_prompt):
    llm_response = c_to_y(intermediate_prompt=intermediate_prompt)
...
with gr.Blocks(css=css, js=js) as demo:
    ...
    gr.HTML(
        ...
        <div id="instructions" style="margin: 20px; padding: 15px; border: 1px solid #D1E8FF; background-color: #F9F9F9; border-radius: 8px;">
            ...
            <ol style="text-align: center; color: #333333; font-size: 16px; line-height: 1.6;">
                <li>
    ...
    with gr.Row():
        ...
        intermediate_output = gr.Textbox(
            ...
            lines=10,
            info="This is the generated prompt to ask a LLM to provide the final diagnosis. The prompt contains the predicted dermoscopic concepts. You can modify the prompt before passing them to the language model."
        )
